...
<div id='aapvl_table' class='container-fluid' align='center'><!-- start div for site content end div tag is in footer template -->
    <h3><?php echo $_SESSION["language_json"]["Header_Enterprise_Case"]; ?></h3>
    <table id='aapvl_table_case01' class='display'>
        ...
        <tbody>
            ...
            <?php foreach ($this->cases_from_db AS $case) { ?>
                <tr>
                    <td><a href="<?php echo URL; ?>case01/show/<?php echo $case->pk_cases ?>"><?php echo $case->id_cases ?></a></td>
...
<div id="aapvl_buttons">
    <a href="<?php echo URL;?>case01/add" class="btn btn-default" role="button"><?php echo $_SESSION["language_json"]["Button_Add"]; ?></a>
</div>    
