 ...
 */
  ...
  $(document).ready(function() {
    ...
    var table = $('#aapvl_table_judgement_cases01').DataTable( {
     ...
     "columnDefs": [{
       ...
       'createdRow': function(row, data, dataIndex){
             ...
             $('td:eq(14)', row).css('min-width', '80px').attr('name', 'Kommentar').attr('id', data[0]).css('vertical-align', 'top');
             $('td:eq(15)', row).css('min-width', '80px').attr('name', 'Bearbeiter').attr('id', data[0]).css('vertical-align', 'top');
          },
    ...
    //    ajax: "../server/server_processing_.php",
        "ajax": $.fn.dataTable.pipeline({
            url: '../../server/server_processing_.php?table=results_',
            pages: 5, // number of pages to cache
        }),
        "keys": true,
        ...
        initComplete: function () {
              ...
              var column_shop = this.api().column(10);
              ...
              var column_lm_shop = this.api().column(11);
              var select = $('<select><option value=""></option></select>')
  ...
  var newValue = null;
  			$(document).on('blur', '.update', function(){
  				...
  				{
  					$.ajax({
  						url : '../../server/updateDataCase01.php?table=results_',
  						method : 'post',
  						data :
  						{
